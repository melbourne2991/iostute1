...
- (IBAction)jsonTapped:(id)sender
{
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Oh dear it failed" message:[error localizedDescription] delegate:nil  cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
